...
public class MainActivity extends AppCompatActivity {
    ...
    private void scrollToViewTop(final View view) {
        ...
        mScrollView.post(() -> {
            mScrollView.smoothScrollTo(0, view.getTop() - heightInPixels);
        });
    }
    private CardView createWidget(LayoutInflater inflater) {
        ...
        paintingView.setMode(randomInRange(128, 320), mode);

        SwitchCompat switchButton = cardView.findViewById(R.id.switch_button);
        ...
        switchButton.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            if (isChecked) {
                // Switch is ON
                switchButton.setText(getString(R.string.flowing));
                paintingView.setMode(StoreWrapper.GraphMode.flowing);

                Log.d(TAG, "ON");
            } else {
                // Switch is OFF
                switchButton.setText(getString(R.string.overlay));
        ...
        switchButton.setText(mode == StoreWrapper.GraphMode.flowing ? getString(R.string.flowing) : getString(R.string.overlay));
        switchButton.setChecked(mode == StoreWrapper.GraphMode.flowing ? true : false);
